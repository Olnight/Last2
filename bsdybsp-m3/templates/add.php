<main>
  <?= $nav?>
  <form class="form form--add-lot container <?php if ($error_codes):?>form--invalid<?php endif;?>" action="https://echo.htmlacademy.ru" method="post"> <!-- form--invalid -->
    <h2>Добавление лота</h2>
    <div class="form__container-two">
      <div class="form__item <?php if (isset($error_codes['lot-name'])):?>form__item--invalid<?php endif;?>">
        <label for="lot-name">Наименование <sup>*</sup></label>
        <input id="lot-name" value="<?=getPostVal('lot-name'); ?>" type="text" name="lot-name" placeholder="Введите наименование лота" value="<?=getPostVal('lot-name');?>">
         <span class="form__error"><?=$error_codes['lot-name']?></span>
      </div>
      <div class="form__item" <?php if (!isset($error_codes['$category'])); ?>>
    ...
    <div class="form__item form__item--wide <?php if (!isset($error_codes['message'])):?> form__item--invalid <?php endif; ?>">
    ...
    <div class="form__item form__item--file <?php if (!isset($error_codes['lot-img'])):?> form__item--invalid <?php endif; ?>">
      <label>Изображение <sup>*</sup></label>
      <div class="form__input-file">
        <input class="visually-hidden" name="picture" required placeholder="Добавить изображение"  type="file" id="lot-img">
        <label for="lot-img">
          Добавить
        </label>
    ...
    <div class="form__container-three">
      <div class="form__item form__item--small <?php if (!isset($error_codes['lot-rate'])): ?> form__item--invalid <?php endif; ?>">
      ...
      <div class="form__item <?php if (isset($error_codes['lot-date'])): ?> form__item--invalid <?php endif; ?>">
